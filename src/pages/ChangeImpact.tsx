    ...
    <div className="space-y-6 animate-fade-in-up">
      <div className="flex items-start justify-between">
        <div>
          ...
          >
            AI-powered scenario analysis for design changes
          </p>
        </div>
            ...
            <div className="glass-card p-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-3">
                  ...
                  {(
                    Object.keys(data.before) as Array<keyof typeof data.before>
                  ).map((k) => (
                    <div
                      key={String(k)}
                ...
                <div className="flex flex-col items-center pt-12 space-y-6">
                  <div
                    className="text-center p-2 rounded-lg mb-2 w-full"
                    style={{
                      background: "var(--green-bg)",
                      border: "1px solid var(--green-border)",
                    }}
                ...
                <div className="space-y-3">
                  ...
                  {(
                    Object.keys(data.after) as Array<keyof typeof data.after>
                  ).map((k) => (
                    <div
                      key={String(k)}
                      className="p-3 rounded-xl"
            ...
            <div className="glass-card p-6">
              ...
              <div className="space-y-3">
                {data.dependencies.map((dep, i) => {
                  const c = depColors[dep.type] ?? "var(--green-primary)";
                  return (
                    <div
                      key={i}
              ...
              <div
                className="flex flex-wrap gap-3 mt-4 pt-4 border-t"
