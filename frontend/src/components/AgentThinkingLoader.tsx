...
export const AGENT_STEPS: AgentStep[] = [
  ...
  },
  {
    ...
    name: "ZoningAgent",
    emoji: "🔍",
    role: "Zoning & Environment",
    thinkingLines: [
      "Checking municipal zoning codes and setback requirements...",
      "Analyzing environmental impact and green space regulations...",
      "Verifying height limits and lot coverage compliance...",
      "Formulating zoning and compliance recommendations...",
    ],
    weight: 10,
  },
  {
    ...
    thinkingLines: [
      "Analyzing project scope and labor budget constraints...",
      "Extracting commodity pricing indexes and variance...",
      "Estimating overall construction cost breakdown...",
      "Calculating contingency reserves and cost projections...",
    ],
    weight: 10,
  },
  {
    id: "safety",
    name: "SafetyAlertAgent",
    emoji: "⚠️",
    role: "Safety & Weather Guard",
    thinkingLines: [
      "Evaluating crane operational safety thresholds...",
      "Scanning wind limits and local meteorological safety risks...",
      "Assessing seasonal weather hazards and mitigation plans...",
      "Compiling safety compliance watchdogs and guidelines...",
    ],
    weight: 10,
  },
  {
