  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      {tasks.length === 0 ? (
        ...
        <div className="crew-gantt-wrap w-full overflow-x-auto rounded-xl border border-stone-200 bg-white shadow-xs">
      ...
      {selectedPlan && tasks.length > 0 && (
        <div className="mt-4 premium-card p-4 cursor-default!">
            ...
            {unscheduled.map((plan) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl bg-stone-50 border border-stone-200/60 hover:border-[#F5C518]/40 transition text-xs"
                >
                  <div
