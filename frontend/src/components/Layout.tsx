...
export default function Layout() {
  ...
  const { hasFullscreenLoader, routeTransition, setLoading } = useLoading();

  useEffect(() => {
    setLoading("app-init", true, { type: "fullscreen", message: "Loading ConstructaIQ" });
    const timer = setTimeout(() => setLoading("app-init", false), 800);
