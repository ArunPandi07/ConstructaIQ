...
export const recentAgentActivities = [
  ...
  },
  {
    ...
    action: 'Optimized concrete delivery schedule for 95-degree weather',
    time: '22 min ago',
    severity: 'info',
    icon: 'clock',
  },
  {
    ...
    action: 'Verified steel beam lead times from Houston supplier',
    time: '31 min ago',
    severity: 'info',
    icon: 'package',
  },
  {
    id: 6,
    agent: 'Crew Agent',
    action: 'Cross-checked OSHA certifications for framing crew',
    time: '45 min ago',
    severity: 'success',
    icon: 'check',
  },
...
export const agentTimeline = [
  ...
  { time: '09:07:00', agent: 'Schedule Agent', event: 'Optimizing project timeline and milestones', type: 'start' },
  { time: '09:08:31', agent: 'Schedule Agent', event: 'Critical path identified: 14 weeks to completion', type: 'success' },
  { time: '09:09:15', agent: 'Supplier Agent', event: 'Evaluating material supply chain', type: 'start' },
  { time: '09:10:42', agent: 'Supplier Agent', event: 'Steel supplier lead time: 14 days confirmed', type: 'success' },
  { time: '09:11:00', agent: 'Crew Agent', event: 'Assessing workforce requirements', type: 'start' },
  { time: '09:12:30', agent: 'Crew Agent', event: 'OSHA compliance verified: 96% certification rate', type: 'complete' },
]
